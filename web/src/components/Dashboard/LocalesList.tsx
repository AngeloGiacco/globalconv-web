      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            <Select onValueChange={addLocale}>
              <SelectTrigger>
  ...
  return (
    ...
    >
      <span className="flex items-center gap-2">
        ...
        <span>{langInfo.native_name}</span>
