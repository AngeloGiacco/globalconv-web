...
export const supportedLanguages = [
  ...
  { code: 'CH', name: 'German (Swiss)', native_name: 'Schwiizerdütsch', icon: CH, locale: 'de-CH' },
  { code: 'AT', name: 'German (Austrian)', native_name: 'Österreichisches Deutsch', icon: AT, locale: 'de-AT' },
